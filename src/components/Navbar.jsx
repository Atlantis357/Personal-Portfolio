...
/*   Updated: 2024/01/11 00:55:11 by Abraham Alk      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
function Navbar(props) {
  ...
  return (
    ...
    <nav className='w-full flex py-4 justify-between items-center navbar flex-shrink-0 border-b'>
        ...
        <p className={`md:flex hidden mx-4 pt-1 font-Poppins font-medium text-[16px]  ${props.colorMode.text}`}>WEB DEVELOPER, BIOENGINEER</p>
        </div>
