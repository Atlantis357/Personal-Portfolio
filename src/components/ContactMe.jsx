...
/*   Updated: 2023/07/22 15:45:23 by Abraham Alk      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
const ContactMe = (props) => {
  ...
  return (
    <div className={`w-screen h-auto mx-10 items-cente mb:20 md:mb-32 lg:mb-40`}>


      {/* Contact us */}
      <div className="w-full flex items-center justify-start">
        <div className="mx-auto w-full max-w-lg">
          <h1 className={`text-4xl font-medium ${props.colorMode.text} font-Orbitron`}>
            Contact me
          </h1>
